...
bigwigCompare -b1 "../mapped/both/bw/"${ChIPName}"_MappedOn_t2t-col.20210610_lowXM_both_sort_norm.bw" \
              -b2 "/home/ajt200/analysis/150701_Natasha_gDNA/WT/R1/snakemake_SPO11oligos_t2t-col.20210610/mapped/both/bw/"${controlName}"_MappedOn_t2t-col.20210610_lowXM_both_sort_norm.bw" \
